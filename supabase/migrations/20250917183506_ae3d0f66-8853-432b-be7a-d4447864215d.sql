...
-- First, drop existing foreign key constraints and RLS policies that reference these columns
...
ALTER COLUMN member_id TYPE int USING member_id::text::int;

-- Change likes columns from UUID to int
ALTER TABLE public.likes 
ALTER COLUMN sent_from TYPE int USING sent_from::text::int,
ALTER COLUMN sent_to TYPE int USING sent_to::text::int;

-- Change messages columns from UUID to int
ALTER TABLE public.messages 
ALTER COLUMN sender_id TYPE int USING sender_id::text::int,
ALTER COLUMN receiver_id TYPE int USING receiver_id::text::int;

-- Add foreign key constraints to reference members.member_id
ALTER TABLE public.img_links 
